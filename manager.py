...
def setup_wizard():
    ...
    if ui.confirm("Do you want to build or connect to a Satellite node?", default=True):
        ...
        pwd = getpass.getpass("  Satellite admin password (hidden) [default: r3dh4t7!]: ").strip() or "r3dh4t7!"
    ...
    if ui.confirm("Do you want to build or connect to a Nutanix server?", default=False):
        ...
        nx_pwd = getpass.getpass("  Nutanix admin password (hidden): ").strip() or "r3dh4t7!"
    ...
    if ui.confirm("Do you want to configure ServiceNow integration?", default=False):
        ...
        sn_pwd = getpass.getpass("  ServiceNow password or API token (hidden): ").strip() or "r3dh4t7!"
    ...
    default_admin_pass = getpass.getpass("Default admin password (hidden) [default: r3dh4t7!]: ").strip() or "r3dh4t7!"
