...
class InsightsInventory:
 ...
 if self.org_id:
 params['filter[system_profile][owner_id]'] = self.org_id
 ...
 if 'insights_registered' not in self.inventory:
 self.inventory['insights_registered'] = {'hosts': []}
 self.inventory['insights_registered']['hosts'].append(hostname)
