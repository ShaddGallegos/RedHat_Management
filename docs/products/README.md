...
- **IP:** 10.168.0.27
- **Roles:** `roles/redhat_products/satellite/`
- **Quick Start:** [SATELLITE_6_18_GUIDE.md](satellite/SATELLITE_6_18_GUIDE.md#quick-start)
- **Features:** DHCP, PXE boot, content management, provisioning

### [Identity Management (IdM)](idm/IDM_GUIDE.md)
Centralized identity and access management solution.
- **IP:** 10.168.0.28
- **Roles:** `roles/redhat_products/idm/`
...
Event-driven automation for reactive infrastructure management.
- Location: [eda/](eda/)
...
- Satellite manages OS deployment and infrastructure
...
| Satellite 6.18 | [Full Guide](satellite/SATELLITE_6_18_GUIDE.md) | [Install](satellite/SATELLITE_6_18_GUIDE.md#quick-start) |
...
2. **Satellite** - Configure infrastructure management
3. **AAP** - Deploy automation platform

This sequence ensures proper integration between all components.
