...
def get_token():
    ...
    # Prefer project_prompting_console_redhat_token when present (generated by prompts)
    if 'project_prompting_console_redhat_token' in data:
        return data['project_prompting_console_redhat_token']
    # Try global: console_redhat_token next
