...
The `satellite_lifecycle_config` role configures Satellite 6.18 content lifecycle management including lifecycle environments, content views, filters, and promotion workflows.
