...
The `integration` role orchestrates product-to-product integrations, managing data flow and API connections between Satellite, AAP, IdM, and OpenShift. It enables unified management across the Red Hat infrastructure stack.
...
5. **Test Connectivity** - Verify integration links
6. **Monitor** - Track integration health

## Common Issues & Resolution

### Issue: "Cannot connect to satellite API"
...
- Restrict integration service accounts
...
awx-manage inventory_source get --name satellite
...
- See orchestration_master README for orchestration
- See product-specific READMEs for product details
- See integration/*/README.md for integration specifics
