# firewall_services role

Enables firewalld services/ports for common Red Hat management components (Satellite, AAP, EDA, IdM, Insights, RHC, ansible-cmdb). The role installs and starts firewalld if needed.
