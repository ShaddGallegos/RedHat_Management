...
The `scenario_aap_credentials` role configures credentials in Ansible Automation Platform (AAP). It manages the creation and configuration of all credential types needed for RHIS deployments.
...
- **Satellite Credentials**: Satellite API integration_generic
- **Cloud Credentials**: AWS, Azure, GCP ansible_dev_node_support
