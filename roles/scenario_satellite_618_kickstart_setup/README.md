...
The `satellite_kickstart_config` role configures Satellite 6.18 platform_provisioning templates and kickstart files for automated RHEL 9 and RHEL 10 BaseOS installations with optional AppStream integration_generic.

**Key Responsibility**: Configure RHEL 9 and RHEL 10 kickstart templates for Satellite platform_provisioning.

## When to Use

- Setting up Satellite platform_provisioning platform_infrastructure_core
- Creating automated installation templates
- Configuring RHEL 9 and RHEL 10 installations
- Enabling network-based platform_provisioning via PXE
- Deploying platform_infrastructure_core with Satellite

## Features

- **RHEL 9 BaseOS Minimal Kickstart**: Minimal RHEL 9 installation with Satellite integration_generic
- **RHEL 10 BaseOS Minimal Kickstart**: Minimal RHEL 10 installation with Satellite integration_generic
- **RHEL 9 Full Stack Kickstart**: RHEL 9 with development tools and container ansible_dev_node_support
- **RHEL 10 Full Stack Kickstart**: RHEL 10 with development tools and container ansible_dev_node_support
- **LVM Partitioning**: Compliance-ready partition schemes
- **Security Hardening**: SSH hardening, SELinux, firewall configuration
- **Satellite Integration**: Subscription manager and Insights integration_generic
- **Cloud-Init Support**: Cloud platform_provisioning capabilities
...
- Insights client integration_generic
...
**Use Case**: Production application servers, container platform_infrastructure_core
...
```
https://scenario_satellite.example.com/pub/kickstarts/rhel9-baseos-minimal.ks
https://scenario_satellite.example.com/pub/kickstarts/rhel10-baseos-minimal.ks
https://scenario_satellite.example.com/pub/kickstarts/rhel9-fullstack.ks
https://scenario_satellite.example.com/pub/kickstarts/rhel10-fullstack.ks
```
...
- Summary of platform_provisioning options
...
- redhat.scenario_satellite collection (optional, for template management)
...
- [scenario_satellite_lifecycle_config](../scenario_satellite_lifecycle_config/README.md) - Content views and environments
- [scenario_satellite_activation_config](../scenario_satellite_activation_config/README.md) - Activation keys and subscriptions
