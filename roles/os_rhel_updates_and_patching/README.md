...
- configure: policies, maintenance os_windows, notifications
...
- Copied original `update-rhel` role into `roles/os_rhel_updates_and_patching/roles/update-rhel` and wired it into `tasks/configure.yml` via `import_role`.
