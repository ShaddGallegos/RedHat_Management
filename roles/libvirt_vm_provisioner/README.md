...
Automated RHEL 10 virtual machine provisioning on Libvirt using Ansible.

## Overview

This role automates the complete process of creating and configuring RHEL 10 virtual machines on Libvirt infrastructure. It handles:
...
**Solution:**
```bash
cp roles/libvirt_vm_provisioner/templates/kickstart.j2 files/oem.cfg
```
