# rhis_host_provisioning

Provision infrastructure hosts from Satellite for AAP deployment.

## Purpose

This role handles host provisioning workflow:
...
- `rhis_host_provision` - All provisioning tasks
