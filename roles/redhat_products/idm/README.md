# Role: redhat_products/idm

## Description

The `redhat_products/idm` role orchestrates the deployment of Red Hat Identity Management (IdM) 3.0+. It coordinates directory services, Kerberos authentication, certificate management, DNS integration, and replication setup.
...
- **Replication**: Multi-server replication support
- **Integration**: LDAP integration capabilities
...
| os | Configure OS |
| integration/satellite_idm | Satellite integration |
