# Role: redhat_products/aap

## Description

The `redhat_products/aap` role orchestrates the complete deployment of Ansible Automation Platform (AAP) 2.6+. It coordinates the deployment of all AAP components including controllers, execution environments, event-driven automation, and role-based access control.
...
- Setting up automation infrastructure
...
**Resolution**: Verify LDAP/IdM integration settings
...
- See integration/* for product integrations
